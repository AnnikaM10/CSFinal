...
def mock_redis_client(mocker):
    ...
    mocker.patch('meal_max.models.kitchen_model.redis_client', mock_redis)
    return mock_redis
######################################################
#
#    Add and delete
...
def test_get_stock_price(session, mocker):
    ...
    mock_get_stock_price = mocker.patch('meal_max.models.kitchen_model.UserStocks.get_stock_price')
...
def test_view_portfolio_full_details(session, mocker):
    ...
    mocker.patch('meal_max.models.kitchen_model.UserStocks.get_stock_price', return_value=150.25)
